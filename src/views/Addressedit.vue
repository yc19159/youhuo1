<template>
    <div>
       ...
       <div class="login-content">
             <div class="content">
               <p>收货人</p>
             <input type="text" class="username" v-model="name">
             </div>
             <div class="content">
                <p>手机号</p>
             <input type="text"  class="username" v-model="tel">
             </div>
            
              <div  class="content">
                <p>所在地区</p>
             <input type="text"  class="pwd" v-model="address" @click="showAddress" >
            
             </div>
             <div class="content">
                <p>详细地址</p>
             <input type="text"  class="dbpwd" v-model="addressDetail">
             </div>    
              <div class="isDefaute">
               <span>是否设置为默认地址</span>
    ...
    <div class="van-overlay" ref="zheZhao"></div>
...
export default {
  ...
  mounted(){
    ...
    var that=this;
   this.value="你好你好"
    //  console.log(document.getElementsByClassName("van-field__control")[2])
     function unshow() {
        ...
        var confirm=document.getElementsByClassName('van-picker__confirm')[0];
            ...
            confirm.style.border='white';
             ...
             that.addressInfo=JSON.parse(sessionStorage.addressInfo)
             console.log(that.addressInfo)
             that.name=that.addressInfo.name;
             that.tel=that.addressInfo.tel;
   ...
   methods: {
     ...
     showAddress(){
       console.log(document.getElementsByClassName('van-picker')[0])
       document.getElementsByClassName('van-picker')[0].style.display='block';
       this.$refs.zheZhao.style.display='block';
     },
     onConfirm(val){
       this.address=`${val[0].name}/${val[1].name}/${val[2].name}`
       document.getElementsByClassName('van-picker')[0].style.display='none';
  ...
  document.getElementsByClassName('van-picker')[0].style.display='none';
   this.$refs.zheZhao.style.display='none';
    ...
    onSave() {
     ...
     var address2=this.addressDetail;
...
.van-picker /deep/ .van-picker__cancel, .van-picker /deep/ .van-picker__confirm {
    padding: 0 16px;
    color: #1989fa;
    font-size: 14px;
    background: none;
